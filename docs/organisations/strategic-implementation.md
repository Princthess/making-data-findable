...
_Automated and interoperable information flows between relevant research information systems should be pursued, for example between data repositories, CRIS systems, data management planning tools and other administrative systems. Preventing manual duplication of work for researchers as well as research support staff should be a set goal._
